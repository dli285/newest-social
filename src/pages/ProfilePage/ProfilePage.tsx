...
import { BioInfoItem } from "../../components/BioInfoItem/BioInfoItem";
import { BioDataItem } from "../../components/BioDataItem/BioDataItem";
      ...
      <aside className="RightSide">
        <Bio>
          <div className="bio__data">
            <BioDataItem className="birthday" 
              maintext="День рождения:" 
              spantext="9 августа"
            />
            <BioDataItem className="location" 
              maintext="Город:" 
              spantext="Ташкент" 
            />
            <BioDataItem className="heart"
              maintext="Статус:"
              spantext="Не указано" 
            />
          </div>
          ...
          <BioInfoItem 
            ...
            info="Филиал университета нефти и газа им. Губкина в Ташкенте"
          />
          <BioInfoItem 
            info="Фотограф"
